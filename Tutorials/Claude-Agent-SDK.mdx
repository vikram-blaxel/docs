...
In your project directory, create a file named `index.ts` (TypeScript) or `main.py` (Python) with the following code. Otherwise, [this other code](/Examples/Claude-Agent-SDK-MCP) shows how to **equip the agent with its own **[**Blaxel Sandbox**](/Sandboxes/Overview)**.**
...
<Card title="Connect to a Blaxel sandbox from Claude Agent SDK" icon="thumbs-up" href="../Examples/Claude-Agent-SDK-MCP">
